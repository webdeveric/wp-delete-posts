...
{
    \wp_enqueue_style('delete-posts', plugins_url('/dist/main.css', DELETE_POSTS_FILE), [], DELETE_POSTS_VERSION);
}

function adminScripts()
{
    \wp_register_script('delete-posts', plugins_url('/dist/main.js', DELETE_POSTS_FILE), [], DELETE_POSTS_VERSION, true);
...
{
    include __DIR__ . '/views/delete-posts-page.html';
}
